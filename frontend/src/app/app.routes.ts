...
export const routes: Routes = [
  ...
  { path: 'detalles/:idProyecto', component: DetallesComponent, canActivate: [AdminGuardService] },
  ...
  { path: 'detallesproyecto/:idProyecto', component: DetallesproyectoComponent, canActivate: [AdminGuardService] },
